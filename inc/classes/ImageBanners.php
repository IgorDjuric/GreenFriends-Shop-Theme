    ...
    public function imageUploadField($name)
    {
        ...
        <div class="upload-image-banners-wrapper">
            ...
            <div>
                ...
                <button type="submit" class="remove-image-banners-button">Obrišite sliku</button>
    ...
    public function imageBanners()
    {
        ...
        if (!empty($options)) {
            ...
            foreach ($options as $option) {
                ...
                $link = $option['link'];
                if ($i == 1 || $i % 3 == 1) {
                    $class = 'col-12 gf-image-banners-wider';
                } else {
                    $class = 'col-6 gf-image-banners__item';
                }

                require(__DIR__ . "/../html/imageBanners/imageBanners.phtml");
                $i++;
            }
            echo '</div>';
        }
