...
class ImageSlider
{
    ...
    public function imageCarousel()
    {
        ...
        if (!empty($options)) {
            $class = 'active';
            $i = 0;
            require(__DIR__ . "/../html/imageSlider/carouselHeader.html");
            foreach ($options as $option) {
                ...
                require(__DIR__ . "/../html/imageSlider/carouselImage.phtml");
                $i++;
            }
            require(__DIR__ . "/../html/imageSlider/carouselFooter.html");
        }
    }
}